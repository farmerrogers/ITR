...
puts "Positive Responses: #{responses[:positive]}"
...
responses[:negative] = ["Don't count on it", "My reply is no", "My sources say no", "Outlook is not so good", "Very doubtful"] 

responses[:neutral] = ["Reply hazy, try again", "Ask again later", "Better not to tell you now", "Cannot predict now", "Concentrate and ask again"]

puts "All Responses: #{responses}"
